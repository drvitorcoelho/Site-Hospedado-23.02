...
import { getCityById } from '../config/cities-config';
import { 
...
const CityPage: React.FC = () => {
  ...
  const city = citySlug ? getCityById(citySlug) : null;
    ...
    <div className="flex flex-col bg-background-light">
      ...
      <section className="relative bg-primary text-white py-20 lg:py-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            ...
            <h2 className="text-2xl md:text-3xl font-bold text-secondary mb-4 uppercase tracking-wide">
              Advogado em {city.name} - {city.state}
            </h2>

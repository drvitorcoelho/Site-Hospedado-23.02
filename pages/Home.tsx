...
const criminalData = [
  {
    ...
    description: "Atuação técnica impar em todas as fases da persecução penal, desde o inquérito até os tribunais superiores.",
    services: ["Acompanhamento em Delegacia", "Audiência de Custódia", "Habeas Corpus", "Recursos em Geral"],
    link: "/criminal",
    btnText: "Saiba Mais"
  },
  {
    ...
    description: "Atuação combativa e especializada em plenário para os crimes dolosos contra a vida.",
    services: ["Homicídios Tentados ou Consumados", "Feminicídio e Infanticídio", "Sustentação Oral", "Análise de Provas"],
    link: "/criminal",
    btnText: "Saiba Mais"
  },
  {
    ...
    description: "Garantimos todos os direitos do sentenciado frente ao rigor da Lei de Execução Penal.",
    services: ["Progressão de Regime", "Livramento Condicional", "Remição de Pena", "Revisão Criminal"],
    link: "/criminal",
    btnText: "Saiba Mais"
  }
];
      ...
      <section className="relative bg-primary text-white py-20 lg:py-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <p className="text-xl md:text-2xl text-white font-medium max-w-3xl mx-auto mb-10 text-justify drop-shadow-md">
            Escritório especializado em Direito Previdenciário e Cível. Buscamos oferecer agilidade e segurança jurídica para orientá-lo na conquista de seus direitos, sem sair de casa.
          </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-6xl mx-auto mb-20">
            ...
            <SpecialtyCarousel
              ...
              description="Especialistas em buscar o melhor benefício disponível do INSS para você. Atuamos em concessões, revisões e recursos."
            ...
            {/* 3. Direito Criminal Carousel */}
            <SpecialtyCarousel
              title="Direito Criminal"
              description="Defesa especializada, combativa e artesanal. Atuação profunda no Tribunal do Júri e na garantia de direitos em processos e inquéritos criminais."
              items={criminalData}
          ...
          <div className="mb-20 bg-primary-dark rounded-3xl p-8 md:p-16 relative overflow-hidden">
            ...
            <div className="grid md:grid-cols-3 gap-6 relative z-10">
              <div className="bg-white/10 backdrop-blur-md p-6 rounded-xl border border-white/10">
                ...
                <p className="text-gray-200 italic mb-4">"Excelente atendimento! O Dr. Vitor foi muito atencioso e me orientou adequadamente para obter minha aposentadoria que o INSS havia negado. Recomendo a todos."</p>
              ...
              <div className="bg-white/10 backdrop-blur-md p-6 rounded-xl border border-white/10">
                ...
                <p className="text-gray-200 italic mb-4">"Resolvi meu divórcio de forma muito rápida e sem dor de cabeça. A equipe cuidou de tudo online. Profissiomalismo excelente."</p>
              ...
              <div className="bg-white/10 backdrop-blur-md p-6 rounded-xl border border-white/10">
                ...
                <p className="text-gray-200 italic mb-4">"Muito esclarecedor. Tirou todas as minhas dúvidas sobre o BPC/LOAS para meu filho. Orientou-me adequadamente para obter o benefício."</p>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              ...
              <details className="bg-white rounded-lg shadow-sm border border-gray-200 group">
                ...
                <div className="px-5 pb-5 text-gray-600 border-t border-gray-100 pt-3">
                  Realizamos uma análise inicial para verificar a viabilidade do seu direito. Após essa avaliação, apresentamos um orçamento prévio para cálculos complexos ou planejamento previdenciário detalhado.
                </div>
              </details>
            </div>
